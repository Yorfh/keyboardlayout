...
public:
	...
	BMAOptimizerPrev(unsigned int seed = BMAOptimizerPrev::rd())
	{
...
template<size_t KeyboardSize>
std::random_device BMAOptimizerPrev<KeyboardSize>::rd;

template<size_t KeyboardSize>
const float BMAOptimizerPrev<KeyboardSize>::tolerance = 0.0000001f;